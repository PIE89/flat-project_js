function render(object, isFaved) {
  const markup = `
        <div class="container p-0 pt-5">
    <div class="heading-1">
        Квартира ${object.title}, ${object.square} м2 за ${object.price_total} ₽
    </div>
    ...
    <div class="object">
        ...
        <div class="object__photo">
            <div class="object__photo-wrapper">
                <img src=${object.image} alt="item.image" />
            </div>
        </div>
        <!-- // object__photo -->
        ...
        <div class="object__desc">
            ...
            <div class="object__desc-name">
                ...
                ${isFaved ? "button-favourite--active" : ""}">
                    <i class="fas fa-heart"></i> <span id="fav-text">${
...
<div class="modal-wrapper none">
    <div class="modal">
        <div class="modal__header">
            ...
            ${object.title} <span>${object.flat_number}</span> в ЖК ${object.complex_name} Дом № ${object.building}
...
function toggleFavouriteBtn(isFaved) {
